...
{
  Gnuplot gnuplot = Gnuplot ("ideal-vs-cara.png");

  Experiment aarfExperiment("Avatar ideal");
  Experiment caraExperiment("Avatar Cara");

  gnuplot.AddDataset (aarfExperiment.Run("ns3::IdealWifiManager"));
