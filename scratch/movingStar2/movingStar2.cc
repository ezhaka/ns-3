...
Experiment::AdvancePosition2 (Ptr<Node> node)
{
  ...
  double distance = sqrt(x*x + y*y) + 1;
  double alpha = atan2(y, x);

  position.x = distance * cos(alpha);
  position.y = distance * sin(alpha);
                 ...
                 const NqosWifiMacHelper &wifiMac, const YansWifiChannelHelper &wifiChannel)
{
  ...
  SetupApp(2, Seconds(0.5), Seconds(300.0), devices, c, false);
  SetupApp(3, Seconds(0.5), Seconds(300.0), devices, c, false);
  SetupApp(4, Seconds(0.5), Seconds(300.0), devices, c, false);
  SetupApp(5, Seconds(0.5), Seconds(300.0), devices, c, false);
  SetupApp(6, Seconds(0.5), Seconds(300.0), devices, c, false);

  Simulator::Schedule (Seconds (1.5), &Experiment::AdvancePosition, this, c.Get (0));
  Simulator::Schedule (Seconds (1.5), &Experiment::AdvancePosition2, this, c.Get (1));
  Simulator::Schedule (Seconds (1.5), &Experiment::AdvancePosition2, this, c.Get (2));
  Simulator::Schedule (Seconds (1.5), &Experiment::AdvancePosition2, this, c.Get (3));
  Simulator::Schedule (Seconds (1.5), &Experiment::AdvancePosition2, this, c.Get (4));
  Simulator::Schedule (Seconds (1.5), &Experiment::AdvancePosition2, this, c.Get (5));
