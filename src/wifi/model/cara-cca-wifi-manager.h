 ...
 */
#ifndef CARA_CCA_WIFI_MANAGER_H
#define CARA_CCA_WIFI_MANAGER_H
 ...
 */
class CaraCcaWifiManager : public WifiRemoteStationManager
{
public:
  static TypeId GetTypeId (void);
  CaraCcaWifiManager ();
  virtual ~CaraCcaWifiManager ();
