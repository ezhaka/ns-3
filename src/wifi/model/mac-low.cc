...
void
MacLow::NotifyManagerAboutSifsAfterTx()
{
  m_stationManager->ReportSifsAfterTx();
}
...
MacLow::StartDataTxTimers (WifiTxVector dataTxVector)
{
  ...
  // notify about sifs time after txDuration
  Simulator::Schedule (txDuration + GetSifs (), &MacLow::NotifyManagerAboutSifsAfterTx, this);
